...
- **Favorites**: `FAVORITE_SYMBOLS` (currently XLM, XRP, HYPE, HBAR) always evaluate and always show, bypassing the normal `CRYPTO_MIN_MCAP`/`CRYPTO_MIN_VOLUME` floor, in their own pinned dashboard section shown ahead of the ranked boards.
