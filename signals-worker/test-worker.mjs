...
check('only the 8 named favorites ever appear in the favorites section', built.crypto.favorites.every(f => ['BTC', 'ETH', 'SOL', 'XLM', 'XRP', 'HYPE', 'HBAR', 'ARB'].includes(f.symbol)), JSON.stringify(built.crypto.favorites.map(f => f.symbol)));
