...
export const metadata: Metadata = {
  title: "Services",
  description:
    "AI-powered investment intelligence, due diligence, market entry strategy, field research, and process optimization for investors in Ghana, Nigeria, Kenya, Malawi, and Uganda.",
};
...
const services = [
  {
    ...
    deliverables: [
      "Daily intelligence brief (email or dashboard)",
      "Opportunity scoring (1-100 by sector and country)",
      "Investment memo templates for top-ranked opportunities",
  ...
  },
  {
    ...
    tagline: "Verify before you commit",
    ...
    deliverables: [
      "Full counterparty background check",
      "Land and property title verification",
      "Regulatory compliance review",
      "Local community and stakeholder mapping",
      "Structured risk matrix with mitigation recommendations",
    ],
  },
  {
    id: "market-entry",
    ...
    deliverables: [
      "Country-specific legal and tax structure analysis",
      "Sector licensing requirements and timelines",
      "Operating cost benchmarks",
      "Competitor and incumbent mapping",
      "Recommended local partners and advisors",
    ],
  },
  {
    id: "deal-origination",
    ...
    tagline: "Access deals before they go public",
    ...
    deliverables: [
      "Curated deal pipeline matched to your mandate",
      "Direct introductions to opportunity owners",
      "Pre-screened for regulatory feasibility",
      "Preliminary financial and operational assessment",
      "Ongoing pipeline refresh as new deals emerge",
    ],
  },
  {
    id: "field-research",
    ...
    tagline: "Real data from real people",
    ...
    deliverables: [
      "Custom survey design and questionnaire development",
      "In-country data collection (urban and rural)",
      "Focus groups and key informant interviews",
      "Competitive pricing and market share analysis",
      "Full research report with executive summary",
    ],
  },
  {
    id: "regulatory",
    ...
    tagline: "Know the rules before you play",
    ...
    deliverables: [
      "Sector-specific licensing pathway mapping",
      "Government stakeholder identification and engagement strategy",
      "Policy monitoring and regulatory change alerts",
      "Compliance checklist and documentation support",
      "Representation at key government engagement points",
    ],
  },
  {
    id: "partner-matching",
    icon: "🔗",
    title: "Local Partner Matching & Vetting",
    tagline: "Find partners you can trust",
    desc: "A credible local partner is often the difference between market access and market failure in Africa. We identify, vet, and introduce investors to local partners across legal, operational, distribution, and sector-specific domains. All partners are verified through our due diligence process.",
    deliverables: [
      "Partner candidate identification (3-5 options)",
      "Background and reputation verification",
      "Financial capacity assessment",
      "Structured introduction and negotiation support",
  ...
  },
  {
    id: "infrastructure",
    icon: "🏗️",
    title: "Infrastructure & PPP Opportunity Tracking",
    ...
    deliverables: [
      "Live infrastructure tender tracker",
      "PPP opportunity scoring",
      "Pre-qualification support and documentation",
      "Project finance structure analysis",
      "Government relationship support for bid preparation",
    ],
  },
  {
    ...
    tagline: "Extract more from what you have",
    ...
    deliverables: [
      ...
      "Cost benchmarking against local comparables",
      "Staff productivity and HR structure review",
...
export default function ServicesPage() {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          {services.map(({ id, icon, title, tagline, desc, deliverables, badge }) => (
            <div
              key={id}
              id={id}
              className="bg-navy-800 border border-navy-600 rounded-2xl p-8 scroll-mt-20 hover:border-gold/30 transition-colors"
            >
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        {badge && (
                          <span className="text-xs font-semibold px-2 py-0.5 rounded gradient-gold text-navy">
                            {badge}
                          </span>
                        )}
                      </div>
      ...
      {/* CTA */}
      <section className="bg-navy-800 border-t border-navy-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-black text-white mb-4">Not Sure Where to Start?</h2>
          <p className="text-slate-400 mb-8 max-w-xl mx-auto">
            Tell us your investment mandate or operational challenge and we&apos;ll recommend the right combination of services for your situation.
          </p>
          <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-3 rounded-lg gradient-gold text-navy font-bold hover:opacity-90 transition-opacity">
